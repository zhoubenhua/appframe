...
public class AppUpdateDialog {
	 ...
	 * @param providerAuthorities 应用id
	 */
	public AppUpdateDialog(Context context, String providerAuthorities, final AppUpdateListener updateListener, String downloadUrl, boolean showCancelButton, String saveApkPath) {
...
//				});
	...
	private void installApk()
	{
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
			...
			Uri contentUri = FileProvider.getUriForFile(context, providerAuthorities, apkFile);
